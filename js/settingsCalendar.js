function settingsCalendar() {
	...
	form.addEventListener('change', function(e){
		...
		document.querySelector('#settingsResult').innerHTML = 'Месяц: ' + drawMonth + ', год: ' + drawYear;
	...
	function drawPrevCalendar(value) {
		...
		document.querySelector('.calendar__table').className = 'calendar__table calendar__table--big';
	}

	function setScript(value) {
		document.querySelector('#output').innerText = '<script src="https://github.com/NatalliaK/calendar/blob/master/js/calendar.js"></script><script src="https://github.com/NatalliaK/calendar/blob/master/js/localStorage.js"></script><script >\n(function(){\n var id = ' + value.el + '; \n document.write(\'<div id="\' + id + \'"></div>\');\n' +
			'\t\t\t  new drawInteractiveCalendar({\n' +
			'\t\t\t    el: ' + value.el + ',\n' +
			'\t\t\t    showMonth: ' + value.changeMonth + ',\n' +
